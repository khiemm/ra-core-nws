        ...
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        meta: __assign(__assign(__assign({}, meta), onSuccess), { fetchResponse: restType, fetchStatus: fetchActions_1.FETCH_END })
                    })];
            case 5:
                _b.sent();
            ...
            case 7:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        requestPayload: payload,
                        meta: __assign(__assign(__assign({}, meta), onFailure), { fetchResponse: restType, fetchStatus: fetchActions_1.FETCH_ERROR })
                    })];
            case 8:
                _b.sent();
