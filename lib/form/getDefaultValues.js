...
var getDefaultValues = function (data, defaultValue, defaultValues) {
    ...
    return __assign(__assign(__assign({}, globalDefaultValue), defaultValues), data);
};
...
exports["default"] = reselect_1.createSelector(getRecord, getDefaultValue, getDefaultValuesFromState, function (record, defaultValue, defaultValues) {
