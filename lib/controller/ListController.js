...
var UnconnectedListController = /** @class */ (function (_super) {
    ...
    function UnconnectedListController() {
        ...
        _this.showFilter = function (filterName, defaultValue) {
            ...
            if (typeof defaultValue !== 'undefined') {
                _this.setFilters(__assign(__assign({}, _this.getFilterValues()), (_b = {}, _b[filterName] = defaultValue, _b)));
            }
        };
    ...
    UnconnectedListController.prototype.updateData = function (props) {
        ...
        this.props.crudGetList(this.props.resource, pagination, { field: sort, order: order }, __assign(__assign({}, filter), props.filter));
    };
    UnconnectedListController.prototype.changeParams = function (action) {
        ...
        this.props.push(__assign(__assign({}, this.props.location), { search: "?" + query_string_1.stringify(__assign(__assign({}, newParams), { filter: JSON.stringify(newParams.filter) })) }));
