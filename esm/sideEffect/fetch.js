        ...
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, put({
                        ...
                        meta: __assign(__assign(__assign({}, meta), onSuccess), { fetchResponse: restType, fetchStatus: FETCH_END })
                    })];
            case 5:
                _b.sent();
            ...
            case 7:
                ...
                return [4 /*yield*/, put({
                        ...
                        requestPayload: payload,
                        meta: __assign(__assign(__assign({}, meta), onFailure), { fetchResponse: restType, fetchStatus: FETCH_ERROR })
                    })];
            case 8:
                _b.sent();
